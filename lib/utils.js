...
export function moveElementAwayFromCollision(layout: Layout, collidesWith: LayoutItem,
  ...
  // FIXME: to maintain a left-to-right-to-down order, we have to make tiles move out of the way by going right instead of down. for RGL, it’s this function that needs to be modified to make that happen.
  // and we have to take care of the case when there’s no more space on the right, so the tile has to go to the next row
